// Predefined food library for quick logging.
// Values are per the stated serving. Macros (protein/carbs/fat) are in grams.
// Figures are reasonable approximations for everyday tracking, not lab-exact.
...
const f = (name, category, serving, calories, protein, carbs, fat) => ({
  name, category, serving, calories, protein, carbs, fat,
});
